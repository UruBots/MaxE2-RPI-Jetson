...
| Teleop teclado → CM-550 | `ros2 launch max_bringup teleop_cm550_launch.py` | `cm550_motion_bridge_max_e2.yaml` | Sí (vía `twist_to_motion_node`) | También publica `/max/profile_velocity` |
...
| Seleccionar fuente de motion (mux) | `ros2 launch max_bringup motion_mux_launch.py active_source:=teleop` | N/A | Sí (reemite) | Activa una de: teleop, tracker, apriltag, line |
